...
async def update_slack_channel_destination_handler(
    destination_id: str,
    provider: str,
    template: str,
    routable: bool,
    ...
    log = logger.bind(function="update_slack_channel_destination_handler")
    ...
    if output_format == "json":
        ...
        print(f"Updated Slack channel destination: {data['name']} ({data['id']})")
